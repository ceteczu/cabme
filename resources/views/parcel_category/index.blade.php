                        ...
                        <div class="card-body">
                            ...
                            <div class="userlist-topsearch d-flex mb-3">
                                <div class="userlist-top-left">
                                    <a class="nav-link do_not_create" href="{{ route('parcel-category.create')}}"><i
                                                class="fa fa-plus mr-2"></i>{{trans('lang.create_parcelCategory')}}</a>
                                </div>
                                <div id="users-table_filter" class="ml-auto">
                                    <label>{{ trans('lang.search_by')}}
                                        <div class="form-group mb-0">

                                            <form action="{{ route('parcel-category') }}" method="get">
                                                ...
                                                <div class="search-box position-relative">
                                                    ...
                                                    <a class="btn btn-warning btn-flat"
                                                       href="{{url('parcel-category')}}">Clear</a>
                                                </div>
                                            </form>
                                        </div>
                                    </label>
                            ...
                            <div class="table-responsive m-t-10">
                                ...
                                <table id="example24"
                                    ...
                                    @if(count($parcel_category) > 0)
                                        @foreach($parcel_category as $value)
                                            <tr>
                                                ...
                                                @if (file_exists(public_path('assets/images/parcel_category'.'/'.$value->image))
                                                &&
                                                !empty($value->image))
                                                    <td><img class="rounded" style="width:50px"
                                                             src="{{asset('assets/images/parcel_category').'/'.$value->image}}"
                                                             alt="image"></td>
                                                @else
                                                    <td><img class="rounded" style="width:50px"
                                                ...
                                                <td><a href="{{route('parcel-category.edit', ['id' => $value->id])}}">{{
                                                $value->title}}</a></td>

                                                <td>
                                                    @if ($value->status=="yes")
                                                        <label class="switch"><input type="checkbox" id="{{$value->id}}"
                                                                                     name="publish" checked><span
                                                ...
                                                <td class="action-btn">
                                                    <a href="{{route('parcel-category.edit', ['id' => $value->id])}}"
                                                       class="do_not_edit"><i class="fa fa-edit"></i></a>
                                                    <a href="{{route('parcel-category.delete', ['id' => $value->id])}}"><i
                                ...
                                <nav aria-label="Page navigation example" class="custom-pagination">
                                    {{ $parcel_category->appends(request()->query())->links() }}
                                </nav>
