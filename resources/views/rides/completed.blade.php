    ...
    <div class="page-wrapper">
        ...
        <div class="row page-titles">
            ...
            <div class="col-md-5 align-self-center">
                ...
                <h3 class="text-themecolor">{{trans('lang.completed_rides')}}</h3>
            ...
            <div class="col-md-7 align-self-center">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">{{trans('lang.completed_rides')}}</li>
                            ...
                            <!-- <div class="userlist-top-left">
                                ...
                                <div id="users-table_filter" class="ml-auto">
                                    <div class="form-group mb-0">
                                        <form action="{{ route('rides.completed') }}" method="get">
                                            ...
                                            <div class="search-box position-relative">
                                                ...
                                                <a class="btn btn-warning btn-flat" href="{{url('rides/completed')}}">Clear</a>
                                            </div>
                                        </form>
                                    </div>
                                </div>
